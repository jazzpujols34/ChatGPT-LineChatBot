...
def aoai(q):
    ...
    response_az = openai.Completion.create(
        ...
        prompt="The following is a conversation with an AI assistant. The assistant is helpful, creative, clever, and very friendly. The assistant will only reply with Traditional Chinese if Chinese responses are required. \n \nHuman: Hello, who are you? \nAI: Hello, I am an AI assistant. I am here to help you with anything you need.\nHuman: " + q + "AI: ",
        temperature=0.9,
        max_tokens=256,
        top_p=1,
        frequency_penalty=0,
